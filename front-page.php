...
<?php get_template_part('core/public/templates/tb-about'); ?>
<!-- Project Section    S T A R T -->
<?php get_template_part('core/public/templates/tb-project'); ?>
<!-- Video Section    S T A R T -->
<?php get_template_part('core/public/templates/tb-video'); ?>
<!-- Work Process Section   S T A R T -->
<?php get_template_part('core/public/templates/tb-work-process'); ?>
<!-- Pricing Section   S T A R T -->
<?php get_template_part('core/public/templates/tb-pricing'); ?>
<!-- Team Section   S T A R T -->
<?php get_template_part('core/public/templates/tb-team'); ?>
<!-- Faq Section   S T A R T -->
<?php get_template_part('core/public/templates/tb-faq'); ?>
<!-- Cta Section   S T A R T -->
<?php get_template_part('core/public/templates/tb-cta'); ?>
<!-- Testimonial Section   S T A R T -->
<?php get_template_part('core/public/templates/tb-testimonial'); ?>
<!-- Blog Section    S T A R T -->
<?php get_template_part('core/public/templates/tb-blog'); ?>
<!-- Cta Section   S T A R T -->
